...
import boxflyingLineVertexShader from '../shader/rowbasic/boxflyingLine.vt.glsl'
// 波浪片元着色器
import boxflyingLinefragmentShader from '../shader/rowbasic/boxflyingLine.fs.glsl'
...
export function Demo1 (props) {
  ...
  useEffect(() => {
    ...
    const material = new THREE.RawShaderMaterial({
      vertexShader: boxflyingLineVertexShader,
      fragmentShader: boxflyingLinefragmentShader,
      // 开启双面
